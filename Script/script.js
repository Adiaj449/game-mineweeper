...
function createPoster()
{
    ...
    col1.innerHTML ="<form action="+"mainPage.html"+" method="+"get"+"><center><h1>Welcome to World of MinesWheeper</h1><label for="+"userName"+">Enter Usernme : </label> <input id="+"userName"+ " name ="+"userName"+"type="+"text"+"value="+"Enter"+ " required> <br> <br><button class = "+"btn"+" type="+"submit"+"value="+"PlayGame"+">Play Game</button></center></form>";
